	...
	*/
	...
	window.addEventListener('load', function () {
	  ...
	  spinner.on('change', function (e) {
	    return alert("spinner: ".concat(e.detail));
	  });
	  var slider = new Slider(ctrl.querySelector('.slider'));
	  slider.min = 0;
	  slider.max = 100;
	  slider.on('stop', function (e) {
	    return alert("slider: ".concat(slider.lo, " - ").concat(slider.hi));
	  });
	  var range = new Range(ctrl.querySelector('.range'));
	  range.min = 1;
	  range.max = 21;
	  var dlg;
